...
if __name__ == '__main__':
    ...
    # model with BlockA
    modell, history = train.train(train_loader, val_loader, model.BlockA, epochs=30)
    ...
    # model with BlockB
    modell, history = train.train(train_loader, val_loader, model.BlockB, epochs=30)
    ...
    # model with BlockC
    modell, history = train.train(train_loader, val_loader, model.BlockC, epochs=30)
    ...
    # model with BlockD
    modell, history = train.train(train_loader, val_loader, model.BlockD, epochs=30)
    ...
    # model with BlockDw
    modell, history = train.train(train_loader, val_loader, model.DepthwiseSepD, epochs=30)
    ...
    # model with BlockE
    modell, history = train.train(train_loader, val_loader, model.BlockE, epochs=30)
